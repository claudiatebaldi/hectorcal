...
conc_pcas <- foreach(i=1:31) %dopar%
{
    ...
    hectorcal::compute_pc(scenlist, expts, 'tas', 2006:2100, 1861:2005)
}
...
emiss_pca <- hectorcal::compute_pc(emiss_scenlist, c('esmrcp85', 'esmHistorical'), c('tas','co2'), 2006:2100, 1861:2005)

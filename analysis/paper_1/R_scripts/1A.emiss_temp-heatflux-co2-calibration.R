...
OUTPUT1_DIR  <- file.path(BASE_DIR, 'output', '1A.calibration_results', 'emiss_temp-heatflux-co2', 'calibration1')
...
OUTPUT2_DIR  <- file.path(BASE_DIR, 'output', '1A.calibration_results', 'emiss_temp-heatflux-co2', 'calibration2')
...
OUTPUT3_DIR  <- file.path(BASE_DIR, 'output', '1A.calibration_results', 'emiss_temp-heatflux-co2', 'calibration3')
...
OUTPUT4_DIR  <- file.path(BASE_DIR, 'output','1A.calibration_results', 'emiss_temp-heatflux-co2', 'calibration4')
...
OUTPUT5_DIR  <- file.path(BASE_DIR, 'output', '1A.calibration_results', 'emiss_temp-heatflux-co2', 'final')
...
}, data_name = names(esm_data_list)[7], comp_data = esm_data_list[7])
